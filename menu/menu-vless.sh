...
clear
echo -e " ${z}╭════════════════════════════════════════════╮${NC}"
echo -e " ${z}│$NC\033[41m                   MENU VMES               $NC${z}│$NC"
echo -e " ${z}╰════════════════════════════════════════════╯${NC}"
echo -e " ${z}╭════════════════════════════════════════════╮${NC}"
echo -e " ${z}│$NC ${Blue}1.)${NC} Create Vless Account $NC"
echo -e " ${z}│$NC ${Blue}2.)${NC} Trial Vless Acoount $NC "
echo -e " ${z}│$NC ${Blue}3.)${NC} Delete Account Vless $NC "
echo -e " ${z}│$NC ${Blue}4.)${NC} Renew Account Vless  $NC "
echo -e " ${z}│$NC ${Blue}5.)${NC} Cek User Active XRAY $NC "
echo -e " ${z}│$NC ${Blue}6.)${NC} Detail Account Vless $NC "
echo -e " ${z}│$NC"
