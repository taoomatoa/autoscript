...
NUMBER_OF_CLIENTS=$(grep -c -E "^#! " "/etc/xray/config.json")
        if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
                ...
                echo -e "\\E[0;41;36m     Check Detail XRAY Trojan     \E[0m"
                echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
                echo ""
        ...
        echo -e "\\E[0;41;36m     Check Detail XRAY Trojan      \E[0m"
        echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
        echo " Select number client to view the config"
...
uuid=$(grep "},{" /etc/xray/config.json | cut -b 18-53 | sed -n "${CLIENT_NUMBER}"p)
...
clear
echo -e ""
echo -e "\033[0;34mXRAY/TROJAN${NC}"
echo -e ""
echo -e "Remarks        : ${user}"
...
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "\\E[0;41;36m     Check User Trojan Login       \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
for akun in "${data[@]}"
do
if [[ -z "$akun" ]]; then
...
clear
echo -e " ${z}╭════════════════════════════════════════════╮${NC}"
echo -e " ${z}│$NC\033[41m               MENU TROJAN PREMIUM          $NC${z}│$NC"
echo -e " ${z}╰════════════════════════════════════════════╯${NC}"
echo -e " ${z}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮${NC}"
echo -e " ${z}│$NC ${Blue}1.)${NC} Create Trojan Account $NC"
echo -e " ${z}│$NC ${Blue}2.)${NC} Trial Trojan Account $NC "
echo -e " ${z}│$NC ${Blue}3.)${NC} Delete Account Trojan $NC "
echo -e " ${z}│$NC ${Blue}4.)${NC} Renew Account Trojan  $NC "
echo -e " ${z}│$NC ${Blue}5.)${NC} Cek User Trojan Active $NC "
echo -e " ${z}│$NC ${Blue}6.)${NC} Cek Detail Trojan $NC "
echo -e " ${z}│$NC"
echo -e " ${z}│$NC ${Blue}0.)${NC} Back To Menu      "
echo -e " ${z}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯${NC}"
echo ""
read -p " Select From Option [1-6 or 0 Menu] : " opt
echo -e ""
case $opt in
01 | 1) clear ; add-tr ;;
