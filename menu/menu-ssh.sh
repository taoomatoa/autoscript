...
clear
echo -e " ${z}╭════════════════════════════════════════════╮${NC}"
echo -e " ${z}│$NC\033[41m                  MENU SSH                  $NC${z}│$NC"
echo -e " ${z}╰════════════════════════════════════════════╯${NC}"
echo -e " ${z}╭════════════════════════════════════════════╮${NC}"
echo -e " ${z}│$NC ${Blue}1.)${NC} New SSH Acoount $NC"
echo -e " ${z}│$NC ${Blue}2.)${NC} Trial SSH Acoount  $NC"
echo -e " ${z}│$NC ${Blue}3.)${NC} Delete SSH Acoount  $NC"
echo -e " ${z}│$NC ${Blue}4.)${NC} Renew SSH Account  $NC"
echo -e " ${z}│$NC ${Blue}5.)${NC} Cek User SSH  $NC"
echo -e " ${z}│$NC ${Blue}6.)${NC} Mullog SSH  $NC"
echo -e " ${z}│$NC ${Blue}7.)${NC} Auto Del user Exp  $NC"
echo -e " ${z}│$NC ${Blue}8.)${NC} Auto Kill user SSH  $NC"
echo -e " ${z}│$NC ${Blue}9.)${NC} Cek Member SSH  $NC"
echo -e " ${z}│$NC"
echo -e " ${z}│$NC ${Blue}0.)${NC} Back To Menu  $NC"
echo -e " ${z}╰════════════════════════════════════════════╯${NC}"
echo ""
read -p "  Select From Option [1-9 or 0 Menu] : " opt
echo -e ""
case $opt in
01 | 1) clear ; usernew ;;
02 | 2) clear ; trialssh ;;
