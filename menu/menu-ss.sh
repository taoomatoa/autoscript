...
clear
echo -e " ${z}╭════════════════════════════════════════════╮${NC}"
echo -e " ${z}│$NC\033[41m              MENU SSWS PREMIUM             $NC${z}│$NC"
echo -e " ${z}╰════════════════════════════════════════════╯${NC}"
echo -e " ${z}╭════════════════════════════════════════════╮${NC}"
echo -e " ${z}│$NC ${Blue} 1.)${NC} $purple Create Shadowsock Account $NC"
echo -e " ${z}│$NC ${Blue} 2.)${NC} $purple Trial Shadowsock Account $NC "
echo -e " ${z}│$NC ${Blue} 3.)${NC} $purple Delete Shadowsock Account $NC "
echo -e " ${z}│$NC ${Blue} 4.)${NC} $purple Renew Shadowsock Account $NC "
echo -e " ${z}│$NC ${Blue} 5.)${NC} $purple Cek User Active XRAY $NC "
echo -e " ${z}│$NC ${Blue} 6.)${NC} $purple Detail Shadowsock Account $NC "
echo -e " ${z}│$NC"
echo -e " ${z}│$NC ${r} 0.)${NC}$purple Back To Menu      "
echo -e " ${z}╰════════════════════════════════════════════╯${NC}"
echo ""
