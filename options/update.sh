#wget https://raw.githubusercontent.com/taoomatoa/${GitUser}/main
GitUser="autoscript"
if [ "${EUID}" -ne 0 ]; then
...
ver=$( curl https://raw.githubusercontent.com/taoomatoa/${GitUser}/main/version )
clear
# LINE COLOUR
line=$(cat /etc/line)
# TEXT COLOUR BELOW
...
version=$(cat /home/ver)
new_version=$( curl https://raw.githubusercontent.com/taoomatoa/${GitUser}/main/newversion | grep $version )
#Status Version
...
# UPDATE RUN-UPDATE
cd /usr/bin
wget -O run-update "https://raw.githubusercontent.com/taoomatoa/${GitUser}/main/options/update.sh"
chmod +x run-update
# RUN UPDATE
echo ""
clear
